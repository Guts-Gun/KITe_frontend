...
export function PhoneBookDeleteModal({deleteList}) {
  const [visible, setVisible] = useState(false); 
  const onSubmit = (e) => {
    axios.delete(apiConfig.phoneBookeDeleteList,{data:deleteList})
  ...
  return (
    <>
      ...
      <CModal alignment="center" visible={visible} onClose={() => setVisible(false)}>
        <CModalHeader>
          <CModalTitle>주소록 삭제</CModalTitle>
        </CModalHeader>
        <CModalBody>
...
PhoneBookDeleteModal.propTypes = {
