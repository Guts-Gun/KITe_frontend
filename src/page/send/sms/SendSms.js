        ...
        <CCardBody>
          <CForm className="row g-3">
            <CRow className="mt-3 mb-3">
              <CFormLabel className="col-sm-1">수신자 선택</CFormLabel>
                <CCol xs={11}>
                  <CRow>
                  <CCol sm={12} md={6}>
            ...
            <CRow className="mb-3">
              <CFormLabel className="col-sm-1">전송 시간</CFormLabel>
              <CCol xs={11}>
            ...
            <CRow className="mb-3">
              <CFormLabel className="col-sm-1">발신 번호</CFormLabel>
              <CCol xs={11}>
                 <CInputGroup className="mb-1">
                  <CFormSelect onChange={(e) => setGroupId(e.target.value)}>
            ...
            <CRow className="mb-3">
              <CFormLabel className="col-sm-1">문자 분류</CFormLabel>
            ...
            <CRow className="mb-3">
              <CFormLabel className="col-sm-1">전송 내용</CFormLabel>
              <CCol className="col-sm-11">
                <CRow>
                  <CCol sm={12} md={8}>
